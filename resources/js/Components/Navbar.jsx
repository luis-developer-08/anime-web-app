                ...
                <div className="p-1 flex gap-1">
                    ...
                    >
                        <div className="join">
                            ...
                            <button
                                type="submit"
                                className="btn bg-slate-800 ml-2 join-item btn-sm border-none rounded-sm"
                            >
                        ...
                        >
                            ...
                            !loading &&
                            (animeResults.length || mangaResults.length) ? (
                                <div className="dropdown-content rounded-sm z-[1] w-[80vw] shadow-lg shadow-slate-500 bg-slate-400 ">
                                    <div className="grid grid-cols-2 gap-4 bg-slate-500 rounded-t-sm py-2 text-gray-200 shadow-lg">
                                    ...
                                    <div className="grid grid-cols-2 gap-1 overflow-y-auto h-[40vh] px-2 pt-2 overflow-x-hidden">
                                        <div>
                                            {mangaResults.length > 0 ? (
                                                mangaResults.map((manga) => (
                                                    <div
                                                        ...
                                                        className="flex h-12 items-center rounded-sm bg-slate-300 shadow-md mb-1 gap-1"
                                                    >
                                                        <img
                                                            src={manga.image}
                                                            alt={manga.title}
                                                            className="h-full w-16 object-cover bg-white rounded-s-sm"
                                                        />
                                                        <div className="p-0">
                                            ...
                                            {animeResults.length > 0 ? (
                                                animeResults.map((anime) => (
                                                    <div
                                                        ...
                                                        className="flex gap-1 h-12 items-center rounded-sm bg-slate-300 shadow-md mb-1"
                                                    >
                                                        <img
                                                            src={anime.image}
                                                            alt={
                                                        ...
                                                        <div className="p-0">
                                                            <h2 className="font-bold text-xs capitalize">
                                                                {anime.title.userPreferred.slice(
                                                                    0,
                                                                    8
                                                                ) + "..."}
                                                            </h2>
